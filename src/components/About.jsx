...
export const About = () => {
    ...
    return (
        <section className="section about" id="about">
          ...
          <img src={profileImage} style={{ height:"250px",width:"250px", borderRadius:"100%",boxShadow:"rgba(149, 157, 165, 0.2) 0px 8px 24px", objectFit:"scale-down"}} alt="Jay Patel"></img>
        </div>
